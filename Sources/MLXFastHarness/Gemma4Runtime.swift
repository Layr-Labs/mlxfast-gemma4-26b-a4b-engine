...
// Implementation lives in the Gemma4Runtime*.swift split files.
public enum Gemma4Runtime {}
...
extension Gemma4Runtime {
    ...
    /// construction.
    static func expertStats(from _: Gemma4A4BRuntimeWeightCache) -> ExpertStreamingStats {
        .zero
    }

    static func expertStats(from _: Gemma4A4BWeightLoader?) -> ExpertStreamingStats {
        .zero
    }
}
