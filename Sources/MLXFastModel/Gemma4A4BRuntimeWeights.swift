...
private func gemma4B8RectangularQuantizedMM(
    ...
    guard let positionBatches = gemma4PrepareB8PositionBatches(x) else { return nil }
    ...
    return gemma4RestoreB8PositionOutput(output)
}
    ...
    Gemma4B8PreparedQuantizedLinear
{
    ...
    override func callAsFunction(_ x: MLXArray) -> MLXArray {
        guard let positionBatches = gemma4PrepareB8PositionBatches(x)
    ...
    func gemma4ProjectPreparedB8(_ positionBatches: MLXArray) -> MLXArray {
        ...
        var result = gemma4RestoreB8PositionOutput(output)
        if let bias {
            result = result + bias
        }
        return result
