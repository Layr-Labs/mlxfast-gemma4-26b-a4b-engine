...
private final class Gemma4Batch8Depth3Verifier: CBv2MTPInstalledVerifier {
    let geometry = CBv2MTPVerificationGeometry(batchSize: 8, draftDepth: 3)
    ...
    func forwardWithHidden(
        ...
        precondition(tokens.ndim == 2 && tokens.shape == [8, 4])
...
extension Gemma4TextModel: CBv2MTPVerifierInstallable {
    public func installCBv2MTPVerifier() -> (any CBv2MTPInstalledVerifier)? {
        ...
        return Gemma4Batch8Depth3Verifier(target: self, tiedHead: tiedHead)
    }
}
