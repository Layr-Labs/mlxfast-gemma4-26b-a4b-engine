...
/// break ties. The optional order-key path encodes that same ordering once per
...
/// `DARKBLOOM_GEMMA4_ROUTE_ORDER_KEYS=0` retains its original comparator.
/// Engage marks: `glue-fold` and, when enabled, `route-order-keys`.
