...
// Candidate EXP-025: crown 9e4840b rebase + 2048MB/1024op unfragmented Metal command buffer budget (preventing mid-expert splits) + prefill glue single-fence barrier elimination + record 1.651s decode ({0,1} ladder, lock-free LM head & D512 caches) + 6-layer prefill repeat cadence.
