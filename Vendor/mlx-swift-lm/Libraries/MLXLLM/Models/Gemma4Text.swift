...
// Candidate EXP-016: batched usage snapshot updates + compact participants + uniform starts table + precomputed prefill softmax + attention pipeline refresh yrp4.
