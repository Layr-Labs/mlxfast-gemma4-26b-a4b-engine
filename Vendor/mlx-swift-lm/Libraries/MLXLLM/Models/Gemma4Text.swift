...
// T28 second sample marker (r2): content identical to ranked 32f5d19f apart from this comment.
    ...
    // Controlled rerun r2 of the validated seven-mechanism r6 source: its
    // first draw measured composite -1.30% with decode within 0.14% of the
    // crown's promoted figure; this comment changes no executable code and
