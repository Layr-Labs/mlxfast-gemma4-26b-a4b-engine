...
///
/// The interval is the layer stride at which an intermediate graph is
/// submitted, so a 30-layer tower submits at every multiple of it. `DARKBLOOM_GEMMA4_PREFILL_CHUNK_EVAL=0` restores
