...
// Ranked draw: this archive is a further ranked sample of the promoted tree, carrying no
// mechanism of its own. See the submission note for eleven closed surfaces and their evidence.
