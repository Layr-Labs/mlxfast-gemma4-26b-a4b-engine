...
// Candidate EXP-024: crown 9e4840b rebase (branch-free steady sliding walk + tail peel + RMS-XVEC) + prefill glue single-fence barrier elimination + record 1.651s decode ({0,1} ladder, lock-free LM head & D512 caches) + 6-layer prefill repeat cadence.
