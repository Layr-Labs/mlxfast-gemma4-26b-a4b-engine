...
private enum Gemma4FusedLayerGlue {
    ...
    /// Independent GLUE-002/003 ablation.  Disabling this leaves GLUE-001
    /// active and restores commit 7942eeb's standalone layer-scalar and next
    /// input-norm operations.
