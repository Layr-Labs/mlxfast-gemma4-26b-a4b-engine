...
// Candidate EXP-026: crown 9e4840b rebase + unfragmented Metal command buffer budget (2048MB / 1024op) + restored zero-divergence prefill glue + record 1.650s decode ({0,1} ladder, lock-free LM head & D512 caches, branch-free steady sliding walk).
