...
@_spi(Testing) public func gemma4FusedRMSResidual(
...
@_spi(Testing) public func gemma4FusedDualRMS(
...
public class Gemma4DecoderLayer: Module {
    ...
    public func callAsFunction(
        ...
        var out = gemma4FusedRMSResidual(
            ...
            eps: postAttentionLayernorm.eps, enabled: gemma4FusedRMSSeamsEnabled)
            ...
            let postFeedforwardLayernorm2
        {
            ...
            out = gemma4FusedDualRMS(
                ...
                eps: postFeedforwardLayernorm1.eps, enabled: gemma4FusedRMSSeamsEnabled)
        ...
        out = gemma4FusedRMSResidual(
            ...
            eps: postFeedforwardLayernorm.eps, enabled: gemma4FusedRMSSeamsEnabled)
