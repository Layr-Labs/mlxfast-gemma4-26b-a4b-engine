...
METAL_FUNC void attention_o_qmv_mma8_affine4_g64_impl(
  ...
  // Register carry: two groups of weight codes stay resident while the next
  // groups are read ahead. Addresses are functions of the group index alone
  // and `g_next2` is clamped to the simdgroup's last group.
