...
METAL_FUNC void attention_o_qmv_mma8_affine4_g64_impl(
  ...
  // Keep the crown's one-stage packed-word carry. The isolated two-stage
  // restoration measured negative twice on the live 16c281c base, so this
  // experiment changes only B-operand liveness.
...
"""
    ...
    private static let mma8KernelK4096 = MLXFast.metalKernel(
        name: "cbv2_b8_l1_attention_o_mma8_affine4_g64_k4096_carry_b1_v4",
    ...
    private static let mma8KernelK8192 = MLXFast.metalKernel(
        name: "cbv2_b8_l1_attention_o_mma8_affine4_g64_k8192_carry_b1_v4",
        inputNames: ["x", "w", "scales", "biases"],
        outputNames: ["y"],
        source: """
            const uint3 tid = threadgroup_position_in_grid;
