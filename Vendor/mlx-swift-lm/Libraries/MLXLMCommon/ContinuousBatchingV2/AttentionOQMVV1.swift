...
METAL_FUNC void attention_o_qmv_mma8_affine4_g64_impl(
  ...
  // Two-stage register carry pipeline: weight operands are preloaded two
  // affine groups ahead of arithmetic execution to completely hide device
  // memory latency on Apple Silicon unified memory.
