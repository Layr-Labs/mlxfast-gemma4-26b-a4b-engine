...
"""
    ...
    private static let mma8MultiTileKernelK4096 = MLXFast.metalKernel(
        name: "cbv2_b8_l1_attention_o_mma8_affine4_g64_mt2_k4096_v1",
    ...
    private static let mma8MultiTileKernelK8192 = MLXFast.metalKernel(
        name: "cbv2_b8_l1_attention_o_mma8_affine4_g64_mt2_k8192_v1",
        inputNames: ["x", "w", "scales", "biases"],
        outputNames: ["y"],
        source: """
            const uint3 tid = threadgroup_position_in_grid;
    ...
    public static func matmul(
        ...
        if mma8Enabled {
            if multiTileEnabled {
                ...
                let kernel = inDim == 8192 ? mma8MultiTileKernelK8192 : mma8MultiTileKernelK4096
                return kernel(
