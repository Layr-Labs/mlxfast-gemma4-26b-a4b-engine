...
public enum CBv2AttentionOQMVV1 {
    ...
    /// H1-ATTN arm. Default ON. Inherits the global toggle from
    /// `AttentionQKVMMA8V1.swift`.
    public static let mma8HalfDomainEnabled: Bool =
        CBv2AttentionQKVMMA8V1.fp16DequantEnabled

    private static let mma8KeySuffix = CBv2AttentionQKVMMA8V1.fp16DequantKeySuffix
