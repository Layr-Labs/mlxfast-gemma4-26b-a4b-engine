...
enum CBv2AttentionV1 {
    ...
    private static func attend(
        ...
        guard let softcap else {
            ...
            // PREFILL-FLASH-001: Two-pass attention eliminating scores matrix.
            // For sliding layers (head_dim=256), this eliminates the ~23 GB/prefill
            // scores matrix materialization by using a 2-pass approach.
            // Prior D=512 two-pass (receipt 9b8358a) passed the token gate.
            if let twoPass = CBv2PrefillTwoPassAttentionV1.attend(
