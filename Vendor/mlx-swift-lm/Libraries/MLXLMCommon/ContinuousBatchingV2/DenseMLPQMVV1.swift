...
// byte at the lowest address is the low byte of the word, which is the order
// the element walk reads them in.
template <typename U, int values_per_thread>
...
"""
    ...
    private static let activationSumQMVKernel: MLXFast.MLXFastKernel = MLXFast.metalKernel(
        name: "cbv2_b8_l1_dense_mlp_qmv_affine8_g64_quad_stream_xsum_word_v3_unroll",
