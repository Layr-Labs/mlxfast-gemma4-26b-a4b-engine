...
"""
    ...
    // MLXArray is not Sendable. This once-initialized array is read-only,
    // following the existing shared-constant convention in prefill kernels.
    nonisolated(unsafe) private static let gegluDownCoefficients = MLXArray([
