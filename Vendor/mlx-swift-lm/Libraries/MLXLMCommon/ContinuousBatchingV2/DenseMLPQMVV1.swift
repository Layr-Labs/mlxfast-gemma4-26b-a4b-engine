...
public enum CBv2DenseMLPQMVV1 {
    ...
    /// LANE-SUMS-REARM: default flipped back ON to price the isolated
    /// contribution that was never measured after T28's bundled revert;
    /// `DARKBLOOM_GEMMA4_MLP_MMA8_DOWN_LANE_SUMS=0` restores the revert.
