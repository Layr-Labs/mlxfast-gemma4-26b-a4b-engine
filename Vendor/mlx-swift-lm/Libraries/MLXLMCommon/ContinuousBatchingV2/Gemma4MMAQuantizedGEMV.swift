...
public enum Gemma4MMAQuantizedGEMV {
    ...
    // Controlled rerun r5 of the gated TAILHEAD-DEFERRED + HEAD-TILE-ARGMAX
    // archive: prior draws measured decode 0.2-0.6% off the crown; this
    // comment changes no executable code and exists to receive an
    // independent paired-runner assignment.
