...
public enum Gemma4PrefillGlueV1 {
    ...
    // Hosted control resample: the executable PRENORM-SCATTER-TGMETA-K8
    // mechanism below is unchanged from a3c99ee; this comment distinguishes
    // the archive after Yukon deduplicated an exact resubmission.
