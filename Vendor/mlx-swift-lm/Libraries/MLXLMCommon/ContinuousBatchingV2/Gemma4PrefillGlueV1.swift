...
// Independent current-crown replication by delordemm1; executable source follows public PR #2605 exactly.
//
...
public enum Gemma4PrefillGlueV1 {
    ...
    private static let preNormScatterVecKernel: MLXFast.MLXFastKernel = MLXFast.metalKernel(
        name: "gemma4_prefill_glue_prenorm_scatter_2816_vec4_v3",
