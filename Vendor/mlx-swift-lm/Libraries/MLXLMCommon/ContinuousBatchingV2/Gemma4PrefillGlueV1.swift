...
//
// SCOPE. These engage only on the prefill plane: `[1, chunk >= 2, 2816]`
// bfloat16 with `eps == 1e-6`. The batch-eight decode plane (`[8, 1, 2816]`),
// CBv2 tail-narrowed rows, MTP rectangles and every other dtype or geometry
// fall through to the untouched stock chain. Kill switch:
...
public enum Gemma4PrefillGlueV1 {
    ...
    /// The prefill plane, pinned in every dimension. `dim(1) >= 2` is what keeps
