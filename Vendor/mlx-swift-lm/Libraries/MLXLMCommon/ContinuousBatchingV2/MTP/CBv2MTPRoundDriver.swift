...
final class CBv2MTPRoundDriver {
    ...
    static let submissionDraftDepth = 2 // MTP-CEILING-3: spec-sanctioned participant lever, envelope cap at batch 8; widens the adaptive range, never forces speculation
