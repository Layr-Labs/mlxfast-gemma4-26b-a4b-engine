...
final class CBv2MTPRoundDriver {
    ...
    ///
    /// This submission enables MTP speculation at the full envelope depth.
    /// The adaptive controller starts at depth 0 (warmup) and may explore
    /// up to this ceiling; `.serialTarget` verification guarantees argmax
    /// exactness for the drafted tokens it commits.
