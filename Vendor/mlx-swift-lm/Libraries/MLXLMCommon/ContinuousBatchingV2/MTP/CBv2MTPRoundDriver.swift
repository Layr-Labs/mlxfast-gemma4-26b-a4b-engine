...
final class CBv2MTPRoundDriver {
    ...
    ///
    /// This submission enables MTP speculation with a conservative ceiling of 1.
    /// The adaptive controller may select depth 0 (target-only) or depth 1 per
    /// round. `.serialTarget` verification guarantees argmax exactness for the
    /// drafted tokens it commits.
