...
enum CBv2RaggedComposedD512DecodeAttentionV1 {
    ...
    private static let qkSource: String = """
            ...
            for (int vtg = vtg_lo; vtg < vtg_hi; ++vtg) {
                ...
                T inter[4];
                // The query run stays in the element type it is read in and
                // each component is widened where it is multiplied, instead
                // of widening the whole run ahead of the key walk.
                T v_coeff[GQA][4];
                int bn = lane * 4;
    ...
    private static let qkKernel: MLXFast.MLXFastKernel = MLXFast.metalKernel(
        name: "cbv2_ragged8_sdpa_d512_qk_bf16_g8_qreg_v2",
        inputNames: [
            "queries",
            "k0", "k1", "k2", "k3", "k4", "k5", "k6", "k7",
            "params",
    ...
    private static let qkFencedKernel: MLXFast.MLXFastKernel = MLXFast.metalKernel(
        name: "cbv2_ragged8_sdpa_d512_qk_fenced_bf16_g8_qreg_v2",
        inputNames: [
            "queries",
            "k0", "k1", "k2", "k3", "k4", "k5", "k6", "k7",
            "params", "store_fence",
