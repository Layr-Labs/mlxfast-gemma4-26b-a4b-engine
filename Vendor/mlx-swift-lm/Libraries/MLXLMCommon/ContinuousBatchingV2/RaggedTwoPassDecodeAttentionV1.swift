...
public enum CBv2RaggedTwoPassDecodeAttentionV1 {
    ...
    nonisolated(unsafe) private static var fastResidentSlotQuery: ObjectIdentifier? = nil
    nonisolated(unsafe) private static var fastResidentSlotInputs: ResidentNormRopeInputs? = nil
    ...
    public static func registerResidentNormRope(
        ...
        fastResidentSlotQuery = ObjectIdentifier(normalizedQueries)
        fastResidentSlotInputs = inputs
        return true
    }
    ...
    private static func takeResidentNormRope(
        ...
        let qId = ObjectIdentifier(queries)
        if fastResidentSlotQuery == qId {
            let inputs = fastResidentSlotInputs
            fastResidentSlotQuery = nil
            fastResidentSlotInputs = nil
            if let inputs,
...
public enum CBv2RaggedComposedD512DecodeAttentionV1 {
    ...
    nonisolated(unsafe) private static var fastFullSlotQuery: ObjectIdentifier? = nil
    nonisolated(unsafe) private static var fastFullSlotInputs: FullNormRopeInputs? = nil
    ...
    public static func registerFullNormRope(
        ...
        fastFullSlotQuery = ObjectIdentifier(normalizedQueries)
        fastFullSlotInputs = inputs
        return true
    }
    ...
    private static func takeFullNormRope(
        ...
        let qId = ObjectIdentifier(queries)
        if fastFullSlotQuery == qId {
            let inputs = fastFullSlotInputs
            fastFullSlotQuery = nil
            fastFullSlotInputs = nil
            if let inputs,
