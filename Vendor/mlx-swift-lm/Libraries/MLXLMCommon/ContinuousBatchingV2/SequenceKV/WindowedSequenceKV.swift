...
public final class CBv2WindowedSequenceKV: CBv2SequenceKV, CBv2InnerStateProviding {
    ...
    public var byteCount: Int {
        ...
        // The KVQ-001 mirror is real resident storage and MUST be counted:
        // omitting it made the provider's capacity accounting under-report
        // this row by `2 * kvHeads * window * (headDim + 4)` bytes, which is
        // ~4.3 MB per row per sliding layer.
