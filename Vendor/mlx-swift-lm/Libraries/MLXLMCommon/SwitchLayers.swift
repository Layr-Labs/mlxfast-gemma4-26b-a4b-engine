...
/// The sorted B=8 decode consumer needs `[batch, 1, inputDims]`; the direct
/// path reaches it with one singleton expansion instead of the incumbent
/// two-axis expansion followed by flatten.
/// `DARKBLOOM_SWITCH_DECODE_DIRECT_LHS_SHAPE=0` restores those two incumbent
...
public class SwitchGLU: Module {
    ...
    private func projectExperts(
        ...
        var x = useDirectLhsDecodeShape
            ...
            : MLX.expandedDimensions(input, axes: [-2, -3])
