...
**Background:** full research corpus at `$HOME/Builds/d-inference/docs/research/batching-engine-2026-07/` (reports 01–12) and the plan at `$HOME/Builds/d-inference/docs/batching-engine-v2-plan.md`. Read report 10 (Gemma4/GPT-OSS invariants) before writing any KV/attention code.
