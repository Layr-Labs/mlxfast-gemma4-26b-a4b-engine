...
// Resolve the within-expert run offset with an independent seven-word
// look-back. The ranked cohort has 64 assignments from eight rows, so one
// expert can occur at most eight times and the offset is at most seven. If a
// future geometry exceeds that bound, resume the incumbent walk at the far
// edge of the window.
