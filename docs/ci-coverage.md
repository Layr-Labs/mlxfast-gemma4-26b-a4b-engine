...
checkpoint staged (`./setup.sh && ./setup-qwen-mtp.sh`), while the
DFlash/requant/bind suites gated on 2026-08-27 are fixture-scale and
weights-free -- they need only the built MLX runtime
...
MLXFAST_RUN_MLX_RUNTIME_TESTS Tests/MLXFastTests/DFlashQuantizedLoadingTests.swift 11
MLXFAST_RUN_MLX_RUNTIME_TESTS Tests/MLXFastTests/DFlashRequantOnLoadTests.swift 4
MLXFAST_RUN_MLX_RUNTIME_TESTS Tests/MLXFastTests/Gemma4DFlashForwardTests.swift 11
MLXFAST_RUN_MLX_RUNTIME_TESTS Tests/MLXFastTests/Gemma4DFlashStagedHeadSizeGateTests.swift 2
MLXFAST_RUN_MLX_RUNTIME_TESTS Tests/MLXFastTests/HeadRequantOnLoadTests.swift 4
MLXFAST_RUN_MLX_RUNTIME_TESTS Tests/MLXFastTests/MTPAcceptanceRuleAuditTests.swift 3
MLXFAST_RUN_MLX_RUNTIME_TESTS Tests/MLXFastTests/MTPTargetForwardIdentityTests.swift 2
MLXFAST_RUN_MLX_RUNTIME_TESTS Tests/MLXFastTests/MTPVerificationStrategySealTests.swift 2
MLXFAST_RUN_MLX_RUNTIME_TESTS Tests/MLXFastTests/Model/Gemma4A4BUpstreamEquivalenceTests.swift 3
...
MLXFAST_RUN_MLX_RUNTIME_TESTS Tests/MLXFastTests/RuntimeWorkerFreeRunLegIdentityTests.swift 1
MLXFAST_RUN_MLX_RUNTIME_TESTS Tests/MLXFastTests/RuntimeWorkerMTPRoundExecutionTests.swift 3
MLXFAST_RUN_MLX_RUNTIME_TESTS Tests/MLXFastTests/RuntimeWorkerRecordingExecutorTests.swift 1
MLXFAST_RUN_MLX_RUNTIME_TESTS Tests/MLXFastTests/RuntimeWorkerSpecConfigTests.swift 1
MLXFAST_RUN_MLX_RUNTIME_TESTS Tests/MLXFastTests/RuntimeWorkerSupportTests.swift 2
MLXFAST_RUN_MLX_RUNTIME_TESTS Tests/MLXFastTests/TargetQuantizationBindTests.swift 8
