...
> pinned source moved on 2026-08-14 to the 3.8 27B 4-bit target @
> `eda45ab47f465d08d6558f0353a2346e2eb9d5b3`, identified by the per-file
> sha256+byte pins in `fixtures/reference_qwen3_8_27b_4bit.sha256` rather than
> by a repository name (our own mlx-0.32.0 conversion of the
